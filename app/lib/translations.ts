    ...
    home: {
      ...
      services: {
        ...
        page: {
          hero: {
            badge: 'Our Services',
            title: 'Our services delivered with precision and care',
            subtitle: 'Discover our tailored logistics and customs solutions, built for accuracy, transparency, and rapid execution.',
            cta: 'View Services',
          },
          categories: {
            all: 'All Services',
    ...
    home: {
      ...
      services: {
        ...
        page: {
          hero: {
            badge: 'خدماتنا',
              title: 'خدماتنا تقدم بدقة وعناية',
            subtitle: 'اكتشف حلولنا اللوجستية والجمركية المصممة خصيصاً للدقة والشفافية والتنفيذ السريع.',
            cta: 'عرض الخدمات',
          },
          categories: {
            all: 'جميع الخدمات',
      ...
      faq: {
        ...
        items: [
          {
            question: 'ما هي الخدمات التي تقدمها شركة الخطوط الآمنة؟',
            answer: 'تقدم شركة الخطوط الآمنة خدمات شاملة في التخليص الجمركي واللوجستيات تشمل التخليص الجمركي للصادرات والواردات، استخراج شهادات سابر، تسجيل منتجات هيئة الغذاء والدواء، خدمات النقل، خدمات التخزين والساحات، تتبع الشحنات، والاستشارات الجمركية.',
          },
          {
        ...
        items: [
          {
            ...
            review: 'العمل مع شركة الخطوط الآمنة غيّر عمليات الاستيراد لدينا بشكل كامل. خبرتهم في التخليص الجمركي ومعالجة الشحنات بكفاءة وفرت لنا وقتاً وتكاليف كبيرة. الفريق محترف ومتجاوب ويحقق دائماً في الوقت المحدد.',
          },
          {
            name: 'سارة إبراهيم',
            source: 'حلول اللوجستيات العالمية',
            review: 'شركة الخطوط الآمنة هي شريكنا الموثوق لجميع احتياجات التخليص الجمركي. خدماتهم الشاملة التي تغطي الموانئ البحرية والمطارات والمنافذ البرية، بالإضافة إلى دعمهم على مدار الساعة، تجعلهم الخيار المثالي لأي شركة تتعامل مع التجارة الدولية.',
          },
          {
            name: 'محمد عبدالله',
            source: 'مجموعة عبدالله للتصنيع',
            review: 'منذ الشراكة مع شركة الخطوط الآمنة، شهدنا تحسينات ملحوظة في كفاءة سلسلة التوريد لدينا. خبرتهم في استخراج شهادات سابر وتسجيل المنتجات في الهيئة العامة للغذاء والدواء سهلت عملية تسجيل منتجاتنا بشكل كبير.',
          },
        ],
      },
      makingEasy: {
