...
export default function BlogPostContent({ post }: { post: BlogPost }) {
  ...
  const getShareUrl = () => {
    ...
    return `${siteUrl}/blog/${post.slug || post.id}`;
  };

  const handleShareFacebook = () => {
    const url = encodeURIComponent(getShareUrl());
    const facebookUrl = `https://www.facebook.com/sharer/sharer.php?u=${url}`;
    window.open(facebookUrl, '_blank', 'width=600,height=400,menubar=no,toolbar=no,resizable=yes,scrollbars=yes');
  };
  ...
  const handleShareTwitter = () => {
    ...
    window.open(twitterUrl, '_blank', 'width=600,height=400,menubar=no,toolbar=no,resizable=yes,scrollbars=yes');
  };

  const handleShareLinkedIn = () => {
    const url = encodeURIComponent(getShareUrl());
    const linkedInUrl = `https://www.linkedin.com/sharing/share-offsite/?url=${url}`;
    window.open(linkedInUrl, '_blank', 'width=600,height=400,menubar=no,toolbar=no,resizable=yes,scrollbars=yes');
  };
          ...
          <article className="blog-post-main">
            ...
            <div className="blog-post-share">
              ...
              <div className="blog-post-share-buttons">
                ...
                <button 
                  className={`blog-post-share-btn ${linkCopied ? 'copied' : ''}`}
              ...
              {linkCopied && (
                <div className="blog-post-share-copied-message">
